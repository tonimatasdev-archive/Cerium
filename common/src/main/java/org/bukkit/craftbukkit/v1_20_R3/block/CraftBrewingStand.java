...
public class CraftBrewingStand extends CraftContainer<BlockEntityBrewingStand> implements BrewingStand {

    public CraftBrewingStand(World world, BlockEntityBrewingStand tileEntity) {
