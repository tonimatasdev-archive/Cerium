...
public final class CraftScoreboard implements org.bukkit.scoreboard.Scoreboard {
    ...
    public Team getPlayerTeam(OfflinePlayer player) {
        ...
        net.minecraft.world.scores.Team team = board.getPlayersTeam(player.getName());
    ...
    public Team getEntryTeam(String entry) {
        ...
        net.minecraft.world.scores.Team team = board.getPlayersTeam(entry);
        return team == null ? null : new CraftTeam(this, team);
    }
    ...
    public Team getTeam(String teamName) {
        ...
        net.minecraft.world.scores.Team team = board.getPlayerTeam(teamName);
        return team == null ? null : new CraftTeam(this, team);
    }

    @Override
    public ImmutableSet<Team> getTeams() {
        return ImmutableSet.copyOf(Iterables.transform(this.board.getPlayerTeams(), (Function<net.minecraft.world.scores.Team, Team>) input -> new CraftTeam(CraftScoreboard.this, input)));
    }
