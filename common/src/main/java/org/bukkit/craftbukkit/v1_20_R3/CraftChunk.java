...
public class CraftChunk implements Chunk {
    ...
    private final int x;
    private final int z;
    private static final PalettedContainer<BlockState> emptyBlockIDs = new PalettedContainer<>(net.minecraft.world.level.block.Block.BLOCK_STATE_REGISTRY, Blocks.AIR.defaultBlockState(), PalettedContainer.Strategy.SECTION_STATES);
