...
public class CraftCampfire extends CraftBlockEntityState<BlockEntityCampfire> implements Campfire {

    public CraftCampfire(World world, BlockEntityCampfire tileEntity) {
