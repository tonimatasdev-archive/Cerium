...
public class CraftPlayer extends CraftHumanEntity implements Player {
    ...
    public void setCompassTarget(Location loc) {
        ...
        getHandle().connection.send(new PacketPlayOutSpawnPosition(CraftLocation.toBlockPos(loc), loc.getYaw()));
    }
    ...
    public void playEffect(Location loc, Effect effect, int data) {
        ...
        PacketPlayOutWorldEvent packet = new PacketPlayOutWorldEvent(packetData, CraftLocation.toBlockPos(loc), data, false);
        getHandle().connection.send(packet);
    }
    ...
    public void sendBlockChange(Location loc, Material material, byte data) {
        ...
        PacketPlayOutBlockChange packet = new PacketPlayOutBlockChange(CraftLocation.toBlockPos(loc), CraftMagicNumbers.getBlock(material, data));
        getHandle().connection.send(packet);
    }
    ...
    public void sendBlockChange(Location loc, BlockData block) {
        ...
        PacketPlayOutBlockChange packet = new PacketPlayOutBlockChange(CraftLocation.toBlockPos(loc), ((CraftBlockData) block).getState());
        getHandle().connection.send(packet);
    }
    ...
    public void sendBlockDamage(Location loc, float progress, int sourceId) {
        ...
        PacketPlayOutBlockBreakAnimation packet = new PacketPlayOutBlockBreakAnimation(sourceId, CraftLocation.toBlockPos(loc), stage);
        getHandle().connection.send(packet);
    }
    ...
    public void sendSignChange(Location loc, String[] lines, DyeColor dyeColor, boolean hasGlowingText) {
        ...
        BlockEntitySign sign = new BlockEntitySign(CraftLocation.toBlockPos(loc), Blocks.OAK_SIGN.defaultBlockState());
    ...
    public void setBedSpawnLocation(Location location, boolean override) {
        if (location == null) {
            ...
            getHandle().setRespawnPosition(((CraftWorld) location.getWorld()).getHandle().dimension(), CraftLocation.toBlockPos(location), location.getYaw(), override, false, PlayerSpawnChangeEvent.Cause.PLUGIN);
        }
    }
    ...
    public void openBook(ItemStack book) {
        ...
        getHandle().openItemGui(org.bukkit.craftbukkit.v1_20_R3.inventory.CraftItemStack.asNMSCopy(book), net.minecraft.world.EnumHand.MAIN_HAND);
