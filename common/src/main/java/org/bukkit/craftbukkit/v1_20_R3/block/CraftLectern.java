...
public class CraftLectern extends CraftBlockEntityState<BlockEntityLectern> implements Lectern {

    public CraftLectern(World world, BlockEntityLectern tileEntity) {
