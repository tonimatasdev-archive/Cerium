...
public class CraftBlockState implements BlockState {
    ...
    protected CraftBlockState(World world, BlockPos blockPosition, net.minecraft.world.level.block.state.BlockState blockData) {
    ...
    // If this returns a World instead of only a LevelAccessor, this implies that this BlockState is placed.
