...
public class CraftVillager extends CraftAbstractVillager implements Villager {
    ...
    public boolean sleep(Location location) {
        ...
        Preconditions.checkState(!((EntityBridge) getHandle()).bridge$getGeneration(), "Cannot sleep during world generation");
    ...
    public void wakeup() {
        ...
        Preconditions.checkState(!((EntityBridge) getHandle()).bridge$getGeneration(), "Cannot wakeup during world generation");
