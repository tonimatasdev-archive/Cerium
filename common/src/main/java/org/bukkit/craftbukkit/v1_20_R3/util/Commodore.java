                    ...
                    public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf)
                    {
                        ...
                        if ( modern )
                        {
                            if ( owner.equals( "org/bukkit/Material" ) )
                            {
                                ...
                                {
                                    case "values":
                                        super.visitMethodInsn( opcode, "org/bukkit/v1_20_R3/craftbukkit/util/CraftLegacy", "modern_" + name, desc, itf );
                                        return;
                                    case "ordinal":
                                        super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/v1_20_R3/craftbukkit/util/CraftLegacy", "modern_" + name, "(Lorg/bukkit/Material;)I", false );
                                        return;
                                }
                            }
                                ...
                                || ( owner.startsWith( "org/bukkit/block/" ) && ( desc + " " + name ).equals( "()Lorg/bukkit/Material; getType" ) ) )
                        {
                            ...
                            super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/v1_20_R3/craftbukkit/legacy/CraftEvil", name, Type.getMethodDescriptor( retType, newArgs ), false );
                            return;
                        }
                        ...
                        if ( owner.equals( "org/bukkit/Material" ) )
                        {
                            ...
                            {
                                super.visitMethodInsn( opcode, "org/bukkit/v1_20_R3/craftbukkit/legacy/CraftEvil", name, desc, itf );
                                return;
                            }
                            ...
                            switch ( name )
                            {
                                ...
                                case "getMaterial":
                                case "matchMaterial":
                                    super.visitMethodInsn( opcode, "org/bukkit/v1_20_R3/craftbukkit/legacy/CraftLegacy", name, desc, itf );
                                    return;
                                case "ordinal":
                                    super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/v1_20_R3/craftbukkit/legacy/CraftLegacy", "ordinal", "(Lorg/bukkit/Material;)I", false );
                                    return;
                                case "name":
                                case "toString":
                                    super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/v1_20_R3/craftbukkit/legacy/CraftLegacy", name, "(Lorg/bukkit/Material;)Ljava/lang/String;", false );
                                    return;
                            }
                        }
                        ...
                        {
                            super.visitMethodInsn( opcode, owner, name, desc, itf );
                            super.visitMethodInsn( Opcodes.INVOKESTATIC, "org/bukkit/v1_20_R3/craftbukkit/legacy/CraftLegacy", "toLegacy", "(Lorg/bukkit/Material;)Lorg/bukkit/Material;", false );
                            return;
                        }
